"""
Django settings for qualiCar project.
...
SECRET_KEY = '9co1_l+j3_=ab20^+2s3@o04ncu5t$59+rnq%*$+6qyd5@3cl&'
...
WSGI_APPLICATION = 'qualiCar.wsgi.application'
